...
Get-ChildItem -Path 'C:\','D:\' | Get-Member
'test' | Get-Member
...
Get-ChildItem -Path 'C:\Users' | Where-Object -Property Name -EQ -Value toto
Get-ChildItem -Path 'C:\Users' | Where-Object {$_.Name -eq 'toto'}

Get-ChildItem -Path 'C:\Users' | Where-Object {($_.Name -eq 'toto') -and ($_.LastWriteTime -gt (Get-Date).AddHours(-2))}

Get-ChildItem -Path 'C:\Users' | Select-Object -ExpandProperty Name | Where-Object {$_ -eq 'toto'}
...
Get-ChildItem -Path 'C:\Users' | ForEach-Object -Begin {"Lancement du traitement"} -Process {"Le profil $($_.Name) a été créé le $($_.CreationTime)"} -End {"Fin du traitement"}
